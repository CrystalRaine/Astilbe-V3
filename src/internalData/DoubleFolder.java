...
public class DoubleFolder extends FolderAbstract {
	
	private Folder folder1;
	private Folder folder2;
	
	public DoubleFolder(String label, String filepath, FolderAbstract parent) {
	...
	protected void getStack() {
		if(folder1 == null) {
			folder1 = new Folder("folder1", filepath + "\\folder1", this);
			folder2 = new Folder("folder2", filepath + "\\folder2", this);
			folder1.setSize(getContainedSize());
			folder2.setSize(getContainedSize());
	...
	public void save(String filepath) {
		...
		folder1.save(filepath + "\\folder1");
		folder2.save(filepath + "\\folder2");
	}
